# Задача 2 из домашки 2: Петя и Катя – брат и сестра. Петя – студент, а Катя –
...
# list1 = [1, 2, 3, 4, 5] 
# k = 2
# k %= len(list1) # если к больше длины списка
# res_list = list()
...
#     for key in dict:
#         res_set.add(dict[key].strip()) # strip пробелы убирает 
# print(res_set)
