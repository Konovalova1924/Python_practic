# # Задача 1 из домашки №4: Даны два неупорядоченных набора целых чисел (может быть, с
...
# Задача 2 из домашки №4: В фермерском хозяйстве в Карелии выращивают чернику. Она растет на
...
#     return True
# n = abs(int(input()))
# # abs это модуль, перевод в положительное число
# print(f(n))
